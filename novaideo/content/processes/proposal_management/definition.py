    ...
    def _init_definition(self):
        self.defineNodes(
            ...
            publishasproposal=ActivityDefinition(contexts=[PublishAsProposal],
                                                 description=_(
                                                     "Transform the idea into a proposal"),
                                                 title=_(
            ...
            submit=ActivityDefinition(contexts=[SubmitProposalModeration],
                                      description=_(
                                          "Submit the Proposal to the Moderation"),
                                      title=_("Submit"),
                                      groups=[]),
    ...
    def _init_definition(self):
        self.defineNodes(
            ...
            alert_end=ActivityDefinition(contexts=[AlertEnd],
                                         description=_(
                                             "Alert for the end of an improvement cycle"),
                                         title=_(
                                             "Alert for the end of an improvement cycle"),
                                         groups=[]),
        ...
        self.defineTransitions(
            ...
            TransitionDefinition('alert_end', 'eg2',
                                 has_alert_condition, sync=True),
            TransitionDefinition('pg', 'work'),
            TransitionDefinition(
                'eg1', 'submit', publish_condition, sync=True),
