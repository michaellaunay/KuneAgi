...
class SeeSmartFolderView(BasicView):
    ...
    template = 'novaideo:views/admin_process/templates/see_smartfolder.pt'
    subfoldertemplate = 'novaideo:views/admin_process/templates/see_smartfolders.pt'
...
class OpenFolderView(BasicView):
    ...
    viewid = 'open_folder'
    wrapper_template = 'novaideo:views/admin_process/templates/folder_view_wrapper.pt'
    ...
    def update(self):
        ...
        if template_type == 'bloc':
            self.wrapper_template = 'novaideo:views/admin_process/templates/folder_blocs_view_wrapper.pt'

        objects = get_folder_content(folder, user, **{})
