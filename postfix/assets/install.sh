...
############
# /etc/postfix/main.cf
postconf -e smtpd_banner=${maildomain}" server"
postconf -e biff=no
...
#mail._domainkey.nova-ideo.com nova-ideo.com:mail:/etc/opendkim/domainkeys/nova-ideo.private
EOF
cat >> /etc/opendkim/SigningTable <<EOF
#*@$maildomain mail._domainkey.$maildomain
#*@nova-ideo.com mail._domainkey.nova-ideo.com
EOF
